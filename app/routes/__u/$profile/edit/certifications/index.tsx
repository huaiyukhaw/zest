...
import type { CertificationsWithPostsIncluded } from "~/models/certification.server"
...
export type CertificationLoaderData = {
    certification: CertificationsWithPostsIncluded
}
...
export const loader: LoaderFunction = async ({ params }) => {
    ...
    return json<CertificationLoaderData>({ certification });
}
                            ...
                            <div className="flex gap-9 justify-between py-4" key={id}>
                                ...
                                <div className="flex flex-col grow shrink-0 w-min">
                                            ...
                                            <div className="flex flex-col gap-1 mt-4">
                                                {
                                                    posts.map(({ postId, post }) => (
                                                        ...
                                                        >
                                                            <Link
                                                                to={`../posts/${postId}?by=certifications`}
                                                                className="
                                                                    w-full
                                    ...
                                    <div className="flex items-center flex-wrap gap-1 mt-4">
                                        <Link
                                            to={`../posts/new?certificationId=${id}&by=certifications`}
                                            className="
                                            flex-none

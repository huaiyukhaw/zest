...
import type { WorkExperienceWithPostsIncluded } from "~/models/work-experience.server"
...
export type WorkExperienceLoaderData = {
    workExperience: WorkExperienceWithPostsIncluded
}
...
export const loader: LoaderFunction = async ({ params }) => {
    ...
    return json<WorkExperienceLoaderData>({ workExperience });
}
                            ...
                            <div className="flex gap-9 justify-between py-4" key={id}>
                                ...
                                <div className="flex flex-col grow shrink-0 w-min">
                                            ...
                                            <div className="flex flex-col gap-1 mt-4">
                                                {
                                                    posts.map(({ postId, post }) => (
                                                        ...
                                                        >
                                                            <Link
                                                                to={`../posts/${postId}?by=work-experience`}
                                                                className="
                                                                    w-full
                                    ...
                                    <div className="flex items-center flex-wrap gap-1 mt-4">
                                        <Link
                                            to={`../posts/new?workExperienceId=${id}&by=work-experience`}
                                            className="
                                            flex-none

...
import type { EducationWithPostsIncluded } from "~/models/education.server"
...
export type EducationLoaderData = {
    education: EducationWithPostsIncluded
}
...
export const loader: LoaderFunction = async ({ params }) => {
    ...
    return json<EducationLoaderData>({ education });
}
                            ...
                            <div className="flex gap-9 justify-between py-4" key={id}>
                                ...
                                <div className="flex flex-col grow shrink-0 w-min">
                                    <div className="text-sm font-medium text-gray-700 dark:text-gray-200">
                                        {
                                            (url && published) ? (
                                                ...
                                                >
                                                    {degree}{school && ` at ${school}`}                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-3 h-3 inline-flex">
                                    ...
                                    <div className="flex items-center flex-wrap gap-1 mt-4">
                                        <Link
                                            to={`../posts/new?educationId=${id}&by=education`}
                                            className="
                                            flex-none

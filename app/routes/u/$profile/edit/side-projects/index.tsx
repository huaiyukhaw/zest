...
import type { SideProjectsWithPostsIncluded } from "~/models/side-project.server"
...
export type SideProjectsLoaderData = {
    sideProjects: SideProjectsWithPostsIncluded
}
...
export const loader: LoaderFunction = async ({ params }) => {
    ...
    return json<SideProjectsLoaderData>({ sideProjects });
}
                            ...
                            <div className="flex gap-9 justify-between py-4" key={id}>
                                ...
                                <div className="flex flex-col grow shrink-0 w-min">
                                            ...
                                            <div className="flex flex-col gap-1 mt-4">
                                                {
                                                    posts.map(({ postId, post }) => (
                                                        ...
                                                        >
                                                            <Link
                                                                to={`../posts/${postId}?by=side-projects`}
                                                                className="
                                                                    w-full
                                    ...
                                    <div className="flex items-center flex-wrap gap-1 mt-4">
                                        <Link
                                            to={`../posts/new?sideProjectId=${id}&by=side-projects`}
                                            className="
                                            flex-none

...
import type { AwardsWithPostsIncluded } from "~/models/award.server"
...
export type AwardsLoaderData = {
    awards: AwardsWithPostsIncluded
}
...
export const loader: LoaderFunction = async ({ params }) => {
    ...
    return json<AwardsLoaderData>({ awards });
}
                            ...
                            <div className="flex gap-9 justify-between py-4" key={id}>
                                ...
                                <div className="flex flex-col grow shrink-0 w-min">
                                    ...
                                    <div className="flex items-center flex-wrap gap-1 mt-4">
                                        <Link
                                            to={`../posts/new?awardId=${id}&by=awards`}
                                            className="
                                            flex-none

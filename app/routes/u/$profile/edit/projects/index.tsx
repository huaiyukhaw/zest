...
import type { ProjectsWithPostsIncluded } from "~/models/project.server"
...
export type ProjectsLoaderData = {
    projects: ProjectsWithPostsIncluded
}
...
export const loader: LoaderFunction = async ({ params }) => {
    ...
    return json<ProjectsLoaderData>({ projects });
}
                            ...
                            <div key={id} className="flex gap-9 justify-between py-4 -mx-4 px-4">
                                ...
                                <div className="flex flex-col grow shrink-0 w-min">
                                    ...
                                    <div className="flex items-center flex-wrap gap-1 mt-4">
                                        <Link
                                            to={`../posts/new?projectId=${id}&by=projects`}
                                            className="
                                            flex-none

                ...
                >
                    <div className="relative w-full">
                        ...
                        <Transition
                            ...
                            leaveTo="opacity-0"
                        >
                            <Listbox.Options className="scrollbar-hide z-10 absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white dark:bg-gray-700 py-2.5 shadow-lg text-sm">
                                {options.map((option) => (
                                    <Listbox.Option
                                        key={option}
                                        className={({ active }) =>

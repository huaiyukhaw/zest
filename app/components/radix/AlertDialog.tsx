...
export const Content: React.FC<ContentProps> = forwardRef(
    ({ children, lg = false, closeButton = false, noPadding = false, ...props }, forwardedRef) => (
        <AlertDialogPrimitive.Content {...props} ref={forwardedRef}
            forceMount
            className={clsx(
                "fixed z-50",
                ...
                "focus-visible:outline-none focus-visible:ring focus-visible:ring-yellow-500 focus-visible:ring-opacity-75",
                noPadding ? "p-0" : "p-6",
